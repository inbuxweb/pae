    ...
    (e.prototype.onEventClick = function (e) {
        ...
        (e.prototype.onSelect = function (e) {
            this.$formEvent[0].reset(),
                ...
                this.$modalTitle.text("Agregar Plato"),
                this.$modal.show(),
        ...
        (e.prototype.init = function () {
            var e = new Date(l.now()),
                e =
                    ...
                    [
                        { title: "Almuerzo Saludable (pollo, arroz, integral, brócoli, zanahoria, pimiento)", start: new Date(l.now() + 158e6), end: new Date(l.now() + 338e6), className: "bg-warning" },
                        { title: "Desayuno Energético (avena, plátano, nueces, yogur,miel)", start: e, end: e, className: "bg-success" },
                        { title: "Desayuno Energético (avena, plátano, nueces, yogur,miel)", start: new Date(l.now() + 168e6), className: "bg-info" },
                        { title: "Merienda de frutas", start: new Date(l.now() + 338e6), end: new Date(l.now() + 4056e5), className: "bg-primary" },
                    ]),
                a = this;
