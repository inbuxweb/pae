                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-xl-4">
                                <div class="text-xl-end mt-xl-0 mt-2">
                                    <a href="{{route('ingredient.create')}}" type="button" class="btn btn-primary mb-2 me-2"><i class="mdi mdi-note-plus me-1"></i> Agregar Ingrediente</a>
                                </div>
                            </div><!-- end col-->
                        </div>
                                ...
                                <tbody>
                                    @foreach( $ingredients as $ingredient )
                                        <tr>
                                            ...
                                            <td>
                                                <h5><span class="badge badge-info-lighten">{{ $ingredient['categoria'] }}</span></h5>
                                            </td>
                                            <td>
                                                <h5><span class="badge badge-success-lighten">{{ $ingredient['proveedor'] }}</span></h5>
                                            </td>
                                            <td>
